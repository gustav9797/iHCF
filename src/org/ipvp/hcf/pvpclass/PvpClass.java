...
public abstract class PvpClass {
    ...
    public boolean onEquip(Player player) {
        ...
        player.sendMessage(ChatColor.BLUE + name + " class "+ ChatColor.GRAY + "has been activated.");
        return true;
    }
    ...
    public void onUnequip(Player player) {
        ...
        player.sendMessage(ChatColor.BLUE + name + " class "+ ChatColor.GRAY +  "has been deactivated.");
    }
