...
public class ChatListener implements Listener {
    ...
    static {
        ...
        // TODO: Configurable.
        /*
         * builder.add(UUID.fromString("52c143e2-85ca-4edf-9d83-615cb8f5c41a")). add(UUID.fromString("45060d62-0967-4ccc-83e2-16883499183d")).
         * add(UUID.fromString("186342e7-9d3f-495d-8641-f3a402cd1dd8")). add(UUID.fromString("48d75a3c-3a63-4f3a-9468-df6f90ead502")). add(UUID.fromString("646e401b-0e78-4b4e-ae89-a5d2bdd38201")).
         * add(UUID.fromString("7408a8d4-dfeb-43a8-9955-6001ecdf06df")). add(UUID.fromString("7a645b12-02ad-4cf2-81b5-952566dc3203")). add(UUID.fromString("3162e8bf-9ed3-41c2-b437-a773715c2195")).
         * add(UUID.fromString("e7ad72a6-afc5-49b5-aa17-035b0334d7f8")). add(UUID.fromString("2b940f6c-16c2-4c94-8346-19d63be309e3")). add(UUID.fromString("10ae2682-2321-4b53-ab2c-be25ff2d2c00")).
         * add(UUID.fromString("a3e54366-9676-4f84-ad62-30e79ce84893")). add(UUID.fromString("77755c55-f3bc-4894-9eaa-d140040b65f9")). add(UUID.fromString("59554514-74f5-4eb4-ac55-d35ad340241c")).
         * add(UUID.fromString("86462511-2f0b-4806-ab4d-dc0e466e58f1")). add(UUID.fromString("eae221cf-84b0-4302-ae34-e302685efcf4")). add(UUID.fromString("a6b4a47e-8895-4f48-8cf6-e7e59fce2c48")).
         * add(UUID.fromString("9f039a5d-6a52-475d-bf2e-1b6d0657d090")). add(UUID.fromString("5906eb81-010f-4ca5-b1d7-65998d4c402a")). add(UUID.fromString("631437f0-3b09-40da-9a8f-9d3c6377246d")).
         * add(UUID.fromString("f39b2276-290a-453e-967f-71ea61f30df4")). add(UUID.fromString("bf596f94-c146-4cdf-bcbf-bb2fe0432caa")). add(UUID.fromString("f0b19235-3166-4e6c-a4f0-67edb9fce9ba")).
